...
export class rolesPermission1707468358977 implements MigrationInterface {
    name = 'rolesPermission1707468358977'
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "document_weights_idx" ON "space" ("document_with_weights") `);
    }
