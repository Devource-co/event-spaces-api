...
export class week9C1667306661844 implements MigrationInterface {
  name = 'week9C1667306661844';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "rate" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "description" text NOT NULL, "frequency" text NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_f4deeff8c1d3bd8334f9ab411f6" UNIQUE ("name"), CONSTRAINT "PK_2618d0d38af322d152ccc328f33" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "space" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying, "description" character varying, "youtube_url" character varying, "address_id" uuid, "cancellation_policy_id" uuid, "rate_id" uuid, "owner_id" uuid NOT NULL, "type_id" uuid, "max_guests" integer, "price" numeric, "minimumDuaration" integer, "property_size" character varying, "parking_slots" integer, "onproperty_parking" boolean, "street_parking" boolean, "parking_close" boolean, "avg_rating" integer NOT NULL DEFAULT '-1', "publish" boolean NOT NULL DEFAULT false, "thumbnail_url" character varying, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "REL_4deb2587c578446b6543c2f2ad" UNIQUE ("address_id"), CONSTRAINT "PK_094f5ec727fe052956a11623640" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "booking" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" uuid NOT NULL, "space_id" uuid NOT NULL, "total" numeric NOT NULL, "payment_status" "public"."booking_payment_status_enum" NOT NULL DEFAULT 'pending', "booking_status" "public"."booking_booking_status_enum" NOT NULL DEFAULT 'pending', "payment_id" uuid NOT NULL, "duration" integer NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_49171efc69702ed84c812f33540" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
