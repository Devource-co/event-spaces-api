...
export class week121672054809633 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."payment_method_payment_type_enum" AS ENUM('card', 'mpesa')`);
        await queryRunner.query(`CREATE TYPE "public"."payment_method_card_type_enum" AS ENUM('amex', 'discover', 'mastercard', 'visa')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_452e311c78c418fb45e24fc367" ON "payment_method" ("owner_id") `);
        await queryRunner.query(`CREATE TYPE "public"."blog_type_enum" AS ENUM('blog', 'support', 'guide')`);
        ...
        await queryRunner.query(`ALTER TABLE "payment_method" ADD CONSTRAINT "FK_452e311c78c418fb45e24fc3673" FOREIGN KEY ("owner_id") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "payment_method" DROP CONSTRAINT "FK_452e311c78c418fb45e24fc3673"`);
        await queryRunner.query(`DROP TABLE "blog"`);
        await queryRunner.query(`DROP TYPE "public"."blog_type_enum"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_452e311c78c418fb45e24fc367"`);
        await queryRunner.query(`DROP TABLE "payment_method"`);
        await queryRunner.query(`DROP TYPE "public"."payment_method_card_type_enum"`);
        await queryRunner.query(`DROP TYPE "public"."payment_method_payment_type_enum"`);
    }
